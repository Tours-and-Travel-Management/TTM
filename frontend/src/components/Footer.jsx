 ...
 As to the mountain's will I come.
            ...
            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <li className="nav-item dropdown">
                        <Link className="nav-link dropdown-toggle  fw-bold" to="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Catogeries
                        </Link>
              ...
              <p>
                ...
                <Link className="nav-link dropdown-toggle   mr-3" to="" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                Login
                </Link>
              ...
              <p>
                ...
                <ul>
                  <li className="nav-item dropdown">
                    <Link className="nav-link dropdown-toggle  fw-bold mr-3 " to="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Register
                </Link>
